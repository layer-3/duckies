...
describe('YellowToken', function () {
  ...
  describe('Blacklist', () => {
    ...
    it('Revert on blacklisted renounce role', async () => {
      await expect(
        TokenAsBlacklisted.renounceRole(BLACKLISTED_ROLE, Blacklisted.address),
      ).to.be.revertedWith('Cannot renounce BLACKLISTED_ROLE');
    });
