    ...
    AccessControlUpgradeable
{
    ...
    function _isTransferable(uint256 tokenId) internal view returns (bool) {
        ...
        return
            tokenToDuckling[tokenId].genome.getFlag(Genome.FLAG_TRANSFERABLE);
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (!_isTransferable(firstTokenId))
    ...
    function _mintTo(
        ...
        if (
            magicNum != Genome.BASE_MAGIC_NUMBER &&
            magicNum != Genome.MYTHIC_MAGIC_NUMBER
