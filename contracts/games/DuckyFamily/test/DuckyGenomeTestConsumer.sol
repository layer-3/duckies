...
contract DuckyGenomeTestConsumer {
    ...
    function generateAndSetGene(
        ...
        emit GenomeReturned(
            DuckyGenome.generateAndSetGene(
                genome,
                geneIdx,
                geneValuesNum,
                distrType,
    ...
    function isCollectionMutating(
        ...
        emit BoolReturned(
            DuckyGenome.isCollectionMutating(rarity, mutationChances, bitSlice)
        );
    }
    ...
    function generateUnevenGeneValue(
        ...
        emit Uint8Returned(
            DuckyGenome.generateUnevenGeneValue(valuesNum, bitSlice)
        );
    }
    ...
    function calcUniqIdGenerationParams(
        ...
        return
            DuckyGenome.calcUniqIdGenerationParams(
                pivotalUniqId,
                maxUniqId,
                mythicDispersion
            );
